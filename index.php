                    ...
                    <div class="row">
                        <div class="col-xl-3 col-sm-6 mb-5">
                            <a class="icon-link" href="pilihMenu.php">
                                <div class="card mb-4 shadow-sm">
                                    <img class="bg-white rounded shadow-sm py-5 px-4" src="assets/images/menu.png" data-src="assets/images/inventory.png" alt="" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                                    <div class="card-body">
                        ...
                        <div class="col-xl-3 col-sm-6 mb-5">
                            <a class="icon-link" href="./petugas/login.php">
                                <div class="card mb-4 shadow-sm">
                                    <img class="bg-white rounded shadow-sm py-5 px-4" src="assets/images//userlog.jpg" data-src="assets/images/inventory.png" alt="" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                                    <div class="card-body">
