            ...
            <div class="card-body">
                <form action="" method="POST">
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" class="form-control" id="nama" value="<?php echo $data['username']; ?>" placeholder="Masukkan Nama" name="username">
                    </div>
                    <div class="mb-3 mt-3">
                        <label for="pwd" class="form-label">Password :</label>
                        <input type="password" class="form-control" id="pwd" value="" placeholder="Masukkan Password" name="password">
                    </div>
                    <div class="mb-3">
